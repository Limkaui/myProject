	...
	$(function(){
		$('#roomSelect').change(function(){
			  $.ajax({
	               ...
	               dataType : 'json',
	               data : {
	                  roo_num: $("#roomSelect option:selected").val() 
	               },
...
<div class="page-main-style">
	...
	<div align="right">
		체크인 날짜 <input type="date" id="checkin_date"><br>
		체크아웃 날짜<input type="date" id="checkout_date"><br>
		...
		<c:forEach var="room" items="${room}">	
			<tr>
				...
				<td width="50%">
					...
					<div class="align-right">
						<input type="button" value="객실 예약하기" onclick="location.href='#'">
					</div>
				</td>
			</tr>
		</c:forEach>
